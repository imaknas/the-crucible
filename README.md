...
<p align="center"><em>A branched conversation, one branch read as a transcript, then a three-model debate — as a tree of lanes and as a transcript.</em></p>
...
> The demo and screenshots show a session generated by `scripts/seed_demo.py`. The model responses are real output from GPT-5.4, Claude Sonnet 5, and Gemini 3.1 Pro.
...
<details>
<summary>Regenerating the demo and screenshots</summary>
...
node scripts/capture_screenshots.mjs    # docs/screenshots/*.png (dark mode)
node scripts/record_demo.mjs            # docs/demo.webp (light mode; needs ffmpeg)
```
